  ...
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
    ...
    if (process.arch === 'x64') {
      if ((process.config && process.config.variables && process.config.variables.shlib_suffix === 'dll.a') || (process.config && process.config.variables && process.config.variables.node_target_type === 'shared_library')) {
        try {
        return require('./gribberish-js.win32-x64-gnu.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
        const binding = require('@mattnucc/gribberish-win32-x64-gnu')
        const bindingPackageVersion = require('@mattnucc/gribberish-win32-x64-gnu/package.json').version
        if (bindingPackageVersion !== '1.3.0' && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
          throw new Error(`Native binding package version mismatch, expected 1.3.0 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`)
        }
        return binding
    ...
    if (process.arch === 'x64') {
      ...
      if (isMusl()) {
        try {
          return require('./gribberish-js.linux-loong64-musl.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
        ...
        try {
          return require('./gribberish-js.linux-loong64-gnu.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
    ...
    if (process.arch === 'arm64') {
      try {
        return require('./gribberish-js.openharmony-arm64.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
      ...
      try {
        return require('./gribberish-js.openharmony-x64.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
      ...
      try {
        return require('./gribberish-js.openharmony-arm.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
...
if (!nativeBinding || forceWasi) {
  ...
  try {
    wasiBinding = require('./gribberish-js.wasi.cjs')
  ...
  if (!nativeBinding || forceWasi) {
    try {
      wasiBinding = require('@mattnucc/gribberish-wasm32-wasi')
      nativeBinding = wasiBinding
    } catch (err) {
      if (forceWasi) {
        if (!wasiBindingError) {

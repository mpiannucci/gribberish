...
let __wasmFilePath = __nodePath.join(__dirname, 'gribberish-js.wasm32-wasi.wasm')
const __wasmDebugFilePath = __nodePath.join(__dirname, 'gribberish-js.wasm32-wasi.debug.wasm')

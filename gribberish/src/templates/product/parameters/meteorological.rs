...
pub enum MoistureProduct {
    ...
    #[description = "predominant weather"]
    #[abbrev = "PWTHER"]
    #[unit = "numeric"]
    PredominantWeather = 226,
    #[description = "flat ice accumulation (FRAM)"]
    #[abbrev = "FICEAC"]
    #[unit = "kgm-2"]
    FlatIceAccumulation = 228,
    #[description = "precipitation duration"]
    #[abbrev = "PCPDUR"]
    #[unit = "h"]
    PrecipitationDuration = 234,
    Missing = 255,
}
...
pub enum PhysicalAtmosphericProperties {
    ...
    #[unit = "proportion"]
    SnowAlbedo = 192,
    #[description = "tornado probability"]
    #[abbrev = "TORPROB"]
    #[unit = "%"]
    TornadoProbability = 197,
    #[description = "hail probability"]
    #[abbrev = "HAILPROB"]
    #[unit = "%"]
    HailProbability = 198,
    #[description = "wind probability"]
    #[abbrev = "WINDPROB"]
    #[unit = "%"]
    WindProbability = 199,
    ...
    #[unit = "m"]
    SnowLevel = 236,
    #[description = "dry thunderstorm probability"]
    #[abbrev = "DRYTPROB"]
    #[unit = "%"]
    DryThunderstormProbability = 237,
    #[description = "ellrod index"]
    #[abbrev = "ELLINX"]
    #[unit = "nondim"]
    EllrodIndex = 238,
    #[description = "craven-wiedenfeld aggregate severe parameter"]
    #[abbrev = "CWASP"]
    #[unit = "numeric"]
    CravenWiedenfeldAggregateSevereParameter = 239,
    Missing = 255,
}

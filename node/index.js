  ...
  case 'linux':
    switch (arch) {
      ...
      case 'arm':
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, 'gribberishjs.linux-arm-musleabihf.node')
          )
          try {
            if (localFileExisted) {
              nativeBinding = require('./gribberishjs.linux-arm-musleabihf.node')
            } else {
              nativeBinding = require('gribberishjs-linux-arm-musleabihf')
            }
          } catch (e) {
            loadError = e
          }
      ...
      case 'riscv64':
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, 'gribberishjs.linux-riscv64-musl.node')
          )
          try {
            if (localFileExisted) {
              nativeBinding = require('./gribberishjs.linux-riscv64-musl.node')
            } else {
              nativeBinding = require('gribberishjs-linux-riscv64-musl')
            }
          } catch (e) {
            loadError = e
          }
          ...
          localFileExisted = existsSync(
            join(__dirname, 'gribberishjs.linux-riscv64-gnu.node')
          )
          try {
            if (localFileExisted) {
              nativeBinding = require('./gribberishjs.linux-riscv64-gnu.node')
            } else {
              nativeBinding = require('gribberishjs-linux-riscv64-gnu')
            }
          } catch (e) {
            loadError = e
          }
      ...
      case 's390x':
        localFileExisted = existsSync(
          join(__dirname, 'gribberishjs.linux-s390x-gnu.node')
        )
        try {
          if (localFileExisted) {
            nativeBinding = require('./gribberishjs.linux-s390x-gnu.node')
          } else {
            nativeBinding = require('gribberishjs-linux-s390x-gnu')
          }
        } catch (e) {
          loadError = e
        }
